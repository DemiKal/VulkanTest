...
//template <typename T>
void StageBuffer(Context& context, VertexBuffer& allocBuffer, vk::BufferUsageFlagBits usageFlags)
{
...
{
	StageBuffer(context, triMesh.vertexBuffer, vk::BufferUsageFlagBits::eVertexBuffer);
	StageBuffer(context, triMesh.indexBuffer, vk::BufferUsageFlagBits::eIndexBuffer);
}
